...
<div style="border-bottom: 1px solid #3A3A3C; padding-bottom: 0.75rem; margin-bottom: 1.5rem;">
    <h1 style="margin: 0; font-size: 1.75rem;">11 MODEL INTELLIGENCE</h1>
    <div style="color: #9C9A96; font-size: 0.85rem; margin-top: 4px;">Model registry, performance metrics, PR-AUC curves, and drift tracking</div>
</div>
""", unsafe_allow_html=True)

st.info("Model Intelligence engine ready.")
