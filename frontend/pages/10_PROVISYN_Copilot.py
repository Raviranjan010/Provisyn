...
st.set_page_config(page_title="PROVISYN — PROVISYN Copilot", layout="wide")
...
<div style="border-bottom: 1px solid #3A3A3C; padding-bottom: 0.75rem; margin-bottom: 1.5rem;">
    ...
    <div style="color: #9C9A96; font-size: 0.85rem; margin-top: 4px;">Tool-grounded decision intelligence conversational assistant</div>
</div>
""", unsafe_allow_html=True)

st.info("PROVISYN Copilot engine ready.")
